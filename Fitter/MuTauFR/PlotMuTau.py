...
regions = ['pass','fail']
samples = ['data_obs','ZTT','ZJ','ZMM','TTT','TTL','TTJ','VV','ST','W','QCD']
mc_samples = {
    'pass' : ['ZTT','ZJ','ZMM','TTT','TTL','TTJ','VV','ST','W','QCD'],
    'fail' : ['ZTT','ZJ','ZMM','TTT','TTL','TTJ','VV','ST','W','QCD'],
}
...
def PlotFail(hists,**kwargs):
    ...
    suffix = '_%s_%s_%s'%(wpVsJet,wpVsMu,wpVsEle)        
    suffix += '_'+etabin
    suffix += '_fail'
    if postFit:
        suffix += '_postfit'
